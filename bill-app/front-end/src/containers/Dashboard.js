...
export default class {
  constructor({ document, onNavigate, store, bills, localStorage }) {
    ...
    $('#arrow-icon3').click((e) => {
      return this.handleShowTickets(e, bills, 3)
    })
  ...
  handleEditTicket(e, bill, bills) {
    ...
    $('#btn-accept-bill').click((e) => {
      return this.handleAcceptSubmit(e, bill)
    })
    $('#btn-refuse-bill').click((e) => {
      return this.handleRefuseSubmit(e, bill)
    })
  }
